...
<body>
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-header dropdown-menu-user" aria-labelledby="dropdownprofile">
                            ...
                            <ul class="list-unstyled user-profile-nav">
                                <li><a href="edit.php?edit=<?php echo $id;?>" class="waves-effect waves-light"><i class="la la-user"></i>
                                            Edit Profile</a></li>
    ...
    <section class="mainpanel">
      <div class="pagebody">
        <br><br>
        <a href="addproduct.php"><button type="button" class="btn btn-success waves-effect waves-green">Add Product</button></a>
        <a href="register.php" type="button" class="btn btn-success waves-effect waves-green">Register</a>
        <br><br>
            <div class="card  border-0">
                <div class="card-header py-4">
                    <h5 class="text-secondary font-weight-bold mb-0">Admin Details</h5>
                </div>
                <div class="card-body">
                    <table id="datatable1" class="table table-striped table-borderless w-100">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php $_SESSION['oldfolder']=$result['picture'];?>
                                <img src="<?php echo $result['picture'];?>" height="50" width="50"></td>
                                <td><?php echo $result['access']=='0' ? 'Active' : 'In-Active';?></td>
                                <td class="td_action" align="center">
                                    <a href="edit.php?edit=<?php echo $result['user_id'];?>"><i data-title="Edit" id="editdetails" class="la la-edit"></i></a>
                                  <i onClick="del(<?php echo $result['user_id'];?>)" class="la la-trash"></i>
                                </td>
                            </tr>
                            <p id="p1"></p>
                            <?php
...
<script type="text/javascript">
    function del(user_id)
    {
        ...
        $.ajax({
            type:'post',
            url:'../ajax/ajax_user_delete.php',
            data:{user_id:user_id}
        }).done(function(data){
            $("#p1").html(data).css('color','green');
              location.reload();
        });
    }
</script>
