                    ...
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <button type="button" onclick="register()"
                                class="btn btn-success waves-effect waves-green">Register</button>
                            <h1>Users Tables</h1>
                        </div>
                        <div class="col-sm-6">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="td_action" align="center">
                                                    <a
                                                        href="../forms/edit.php?edit=<?php echo $result['admin_id'];  ?> "><i
                                                            data-title="Edit" id="editdetails"
                                                            class="fas fa-edit"></i></a>
                                                    <a
                                                        href="admindisplay.php?delete=<?php echo $result['admin_id'];  ?>"><i
