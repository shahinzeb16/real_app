                ...
                <form method="post" action="" enctype="multipart/form-data">
                  <div class="card-body">
                    ...
                    <div class="form-group ">
                      ...
                      <input type="text" class="form-control " placeholder="Fullname" name="fname" value="<?php echo $result['fullname']; ?>">
                    </div>
                    <div class="form-group ">
                      <label>Username</label>
                      <input type="text" class="form-control " placeholder="Username" name="uname" value="<?php echo $result['username']; ?>">
                    </div>
                    <div class="form-group ">
                      <label>Email Id</label>
                      <input type="text" class="form-control " name="email" placeholder="john.doe@domain.com" value="<?php echo $result['email']; ?>">
                    </div>
                    <div class="form-group ">
                      <label>Upload Image</label>
                      <input type="file" class="form-control " name="image"><img src="<?php echo $result['image']; ?>" height="50" width="50">
                    </div>
                    <div>
                      <label>Change Role</label>
                      <input type="radio" name="role" value="0" <?php if ($result['role'] == "0"){  echo "checked";} ?>>User
                      <input type="radio" name="role" value="1" <?php  if ($result['role'] == "1") {  echo "checked";  } ?>>Admin
                    </div>
