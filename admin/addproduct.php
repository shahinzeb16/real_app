  ...
  <body>
    ...
    <section style="padding-top:120px;" class="container">
      <div class="input-center">
          ...
          <select class="form-control col-sm-4" id="select_1" name="category">
            <option value="one">Category</option>
            <option value="electronics">Electronics</option>
            <option value="clothing">Clothing</option>
            <option value="appliances">Appliances</option>
          </select><br><br>
          <select class="form-control col-sm-4" id="select_1" name="subcategory">
          ...
          <select class="form-control col-sm-4" id="select_1" name="status">
