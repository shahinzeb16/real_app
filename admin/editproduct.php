...
if(isset($_POST['product_update'])){
    ...
    $updateproduct = $dataobj->updateproduct($product_title, $product_price,$product_description, $product_category, $product_subcategory, $product_quantity,$product_image, $product_size, $product_color, $product_discount, $product_status, $product_location, $product_id);
        ...
        <div class="customcontainer">
            <div class="input-center">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <input type="text" name="product_location" value="<?php echo $result['product_location'] ; ?>"
