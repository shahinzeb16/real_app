                            ...
                            <div class="card-body">
                                <form action="" method="post">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" value="<?php echo $result['name'] ; ?>" id="inputName" class="form-control"
                                    ...
                                    <div class="button-flex">
                                        <button class="btn btn-primary" type="submit" name="category_update">Update</button>
